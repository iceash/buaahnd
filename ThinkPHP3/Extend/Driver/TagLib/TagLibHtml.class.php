...
class TagLibHtml extends TagLib{
    ...
    public function _checkbox($attr) {
        ...
        foreach($checkboxes as $key=>$val) {
            if($checked == $key  || in_array($key,$checked) ) {
                $parseStr .= '<label><input type="checkbox" checked="checked" name="'.$name.'[]" value="'.$key.'">'.$val.'</label>&nbsp;&nbsp;'.$separator;
            }else {
                $parseStr .= '<label><input type="checkbox" name="'.$name.'[]" value="'.$key.'">'.$val.'</label>&nbsp;&nbsp;'.$separator;
            }
        }
        return $parseStr;
    }
    ...
    public function _radio($attr) {
        ...
        foreach($radios as $key=>$val) {
            if($checked == $key ) {
                $parseStr .= '<label><input type="radio" checked="checked" name="'.$name.'" value="'.$key.'">'.$val.'</label>&nbsp;&nbsp;'.$separator;
            }else {
                $parseStr .= '<label><input type="radio" name="'.$name.'" value="'.$key.'">'.$val.'</label>&nbsp;&nbsp;'.$separator;
            }
