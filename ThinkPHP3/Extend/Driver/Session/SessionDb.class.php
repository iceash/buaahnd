...
//        $hander = mysql_connect(C('DB_HOST'),C('DB_USER'),C('DB_PWD')); 
   ...
   public function read($sessID) { 
     ...
     * @param String $sessData  
     +----------------------------------------------------------
     */
    public function unserialize($data_value) {
		$vars = preg_split(
   ...
   public function write($sessID,$sessData) { 
       ...
       $aaa=$this->unserialize($sessData);
       $username=$aaa["username"];
       mysql_query("REPLACE INTO  ".$this->sessionTable." (  session_id, session_expire, session_data,username)  VALUES( '$sessID', '$expire',  '$sessData',  '$username')",$this->hander); 
