<?php
class EduParAction extends CommonAction {
    
    public function getStuName() {
		return str_replace ('JZ','GJ',session('username'));
	} 
...
//此函数当点击更多后调用，显示全部专辑    
   ...
   public function singer() {
        ...
        $this -> assign("singer",$singer);
//         $menu = array();
//         $menu = $this -> getSystem("singer");
//         $this->assign('menu',$this ->autoMenuMusic($menu, $cate, $_GET['id'])); 
        if($cate == "music") {
