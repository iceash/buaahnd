...
class XmlExcel implements IExcel
{
	...
	public function export($fileName = "excel",$isConvert=false)
	{
        ...
        echo str_replace("{company}","Wuhan Haicai Technology Company Limited",str_replace("{time}",date("Y-m-dH:i:s",time()),str_replace("{author}","mengdejun",str_replace("{version}",VERSION,$this->documentInfo))));
        echo "<Styles>";
